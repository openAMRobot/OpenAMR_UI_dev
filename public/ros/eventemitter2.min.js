...
!(function (e) {
  var t = Object.hasOwnProperty,
    ...
    n = "object" == typeof process && "function" == typeof process.nextTick,
  ...
  function f(t) {
    t &&
      ...
      t.maxListeners !== e && (this._maxListeners = t.maxListeners),
      ...
      t.ignoreErrors && (this.ignoreErrors = t.ignoreErrors),
  ...
  function u(t, r) {
    for (var n = {}, i = t.length, s = r ? r.length : 0, o = 0; o < i; o++)
      n[t[o]] = o < s ? r[o] : e;
    return n;
  }
  function p(e, t, r) {
  ...
  function v(r, n, i, s) {
    ...
    if (!r) return o;
    if ("object" != typeof r) throw TypeError("options must be an object");
    var l,
      a,
      f,
      h = Object.keys(r),
    ...
    function u(e) {
      throw Error(
        'Invalid "' + l + '" option value' + (e ? ". Reason: " + e : ""),
      );
    }
    for (var p = 0; p < c; p++) {
  ...
  function _(e) {
    ...
    return 1 === r
      ...
      : function (n, i) {
          for (var s = typeof n, o = r; o-- > 0; ) if (s === e[o]) return n;
          i(t);
        };
  }
  Object.assign(p.prototype, {
    subscribe: function (e, t, r) {
      var n = this,
        ...
        l = function () {
          ...
          } else s.emit.apply(s, [t].concat(n));
        };
      if (o[e]) throw Error("Event '" + e + "' is already listening");
      this._listenersCount++,
        s._newListener && s._removeListener && !n._onNewListener
          ? ((this._onNewListener = function (r) {
              r === t && null === o[e] && ((o[e] = l), n._on.call(i, e, l));
            }),
            ...
            (this._onRemoveListener = function (r) {
              r === t &&
                !s.hasListeners(r) &&
                o[e] &&
                ((o[e] = null), n._off.call(i, e, l));
            }),
            (o[e] = null),
            s.on("removeListener", this._onRemoveListener))
          : ((o[e] = l), n._on.call(i, e, l));
    },
    unsubscribe: function (e) {
      ...
      function h() {
        i._onNewListener &&
          (o.off("newListener", i._onNewListener),
          o.off("removeListener", i._onRemoveListener),
      ...
      if (e) {
        ...
        for (n = (r = l(s)).length; n-- > 0; ) (e = r[n]), a.call(f, e, s[e]);
        ...
        n
          ...
          r.timeout > 0 &&
            (o = setTimeout(function () {
              var e = Error("timeout");
              (e.code = "ETIMEDOUT"), (o = 0), l.cancel(e), f(e);
            }, r.timeout));
      });
    return (
      n ||
    ...
    if (n === i)
      r._listeners &&
        ("function" == typeof r._listeners
          ? (e && e.push(r._listeners), (w = [r]))
          : (e && e.push.apply(e, r._listeners), (w = [r])));
    else {
      if ("*" === L) {
        ...
        for (y._listeners && g(e, t, y, i, i), a = (d = l(y)).length; a-- > 0; )
          "_listeners" !== (p = d[a]) &&
            (p === E
              ...
              : p === L
              ? g(e, t, y[p], n + 1, i)
              : (((_ = {})[p] = y[p]), g(e, t, { "**": _ }, n + 1, i)));
      else
        y._listeners
          ? g(e, t, y, i, i)
          : y["*"] && y["*"]._listeners && g(e, t, y["*"], i, i);
    return w;
  }
  function L(e, t, r) {
    var n,
          ...
          c._listeners
            ? ("function" == typeof c._listeners &&
              ...
              !c._listeners.warned &&
                ...
                h.call(this, c._listeners.length, f)))
            : (c._listeners = t),
          !0
        );
    return !0;
  ...
  function E(e, t, r, n) {
    for (var i, s, o, a, f = l(e), h = f.length, c = e._listeners; h-- > 0; )
      (i = e[(s = f[h])]),
        (o = "_listeners" === s ? r : r ? r.concat(s) : [s]),
        (a = n || "symbol" == typeof s),
        c && t.push(a ? o : o.join(this.delimiter)),
        "object" == typeof i && E.call(this, i, t, o, a);
    return t;
  }
  function k(e) {
    for (var t, r, n, i = l(e), s = i.length; s-- > 0; )
      (t = e[(r = i[s])]) &&
        ((n = !0), "_listeners" === r || k(t) || delete e[r]);
    return n;
  }
  function j(e, t, r) {
  ...
  function T(t, r, i) {
    ...
    if (s || a || l) {
      var h = r,
        c = r._origin || r;
      if (a && !n) throw Error("process.nextTick is not supported");
      l === e && (l = "AsyncFunction" === r.constructor.name),
        (r = function () {
          var e = arguments,
            t = this,
            r = this.event;
          return l
            ? a
              ...
              : new Promise(function (e) {
                  ...
                  return (t.event = r), h.apply(t, e);
                })
            : (a ? process.nextTick : o)(function () {
                (t.event = r), h.apply(t, e);
              });
        }),
        (r._async = !0),
        (r._origin = c);
    }
    return [r, f ? new j(this, t, r) : this];
  }
  function x(e) {
    (this._events = {}),
      (this._newListener = !1),
  ...
  (j.prototype.off = function () {
    ...
    (x.EventEmitter2 = x),
    (x.prototype.listenTo = function (t, n, i) {
      ...
      function o(e) {
        ...
        var r,
          n = i.reducers,
          o = w.call(s, t);
        r = -1 === o ? new p(s, t, i) : s._observers[o];
        for (
          var a, f = l(e), h = f.length, c = "function" == typeof n, u = 0;
          u < h;
          u++
        )
          (a = f[u]), r.subscribe(a, e[a] || a, c ? n : n && n[a]);
      }
      return (
        (i = v(
          i,
          { on: e, off: e, reducers: e },
          { on: m, off: m, reducers: d },
        )),
        r(n) ? o(u(n)) : o("string" == typeof n ? u(n.split(/\s+/)) : n),
        this
      );
    }),
    (x.prototype.stopListeningTo = function (e, t) {
      ...
      for (; i-- > 0; )
        (n = r[i]), (e && n._target !== e) || (n.unsubscribe(t), (s = !0));
      return s;
    }),
    ...
    (x.prototype.event = ""),
    (x.prototype.once = function (e, t, r) {
      return this._once(e, t, !1, r);
    }),
    (x.prototype.prependOnceListener = function (e, t, r) {
      return this._once(e, t, !0, r);
    }),
    (x.prototype._once = function (e, t, r, n) {
      return this._many(e, 1, t, r, n);
    }),
    (x.prototype.many = function (e, t, r, n) {
      return this._many(e, t, r, !1, n);
    }),
    (x.prototype.prependMany = function (e, t, r, n) {
      return this._many(e, t, r, !0, n);
    }),
    (x.prototype._many = function (e, t, r, n, i) {
      var s = this;
      if ("function" != typeof r)
        throw new Error("many only accepts instances of Function");
      function o() {
        return 0 == --t && s.off(e, o), r.apply(this, arguments);
      }
      return (o._origin = r), this._on(e, o, n, i);
    }),
    (x.prototype.emit = function () {
      ...
      if (
        f &&
        ((e = l),
        "newListener" !== l && "removeListener" !== l && "object" == typeof l)
      ) {
        if (((r = l.length), i))
          for (n = 0; n < r; n++)
      ...
      if (f) (h = []), g.call(this, h, e, this.listenerTree, 0, r);
      else {
      ...
      if (h && h.length) {
        if (c > 3)
          for (t = new Array(c - 1), s = 1; s < c; s++) t[s - 1] = arguments[s];
        ...
        for (s = 0, n = this._all.length; s < n; s++)
          switch (((this.event = l), u)) {
            ...
            case 3:
              ...
              break;
            default:
              c.push(this._all[s].apply(this, arguments));
          }
      if (
        (f
          ? ((h = []), g.call(this, h, e, this.listenerTree, 0))
          : (h = this._events[l]),
        "function" == typeof h)
      )
        switch (((this.event = l), u)) {
        ...
        if (((h = h.slice()), u > 3))
          for (r = new Array(u - 1), o = 1; o < u; o++) r[o - 1] = arguments[o];
    ...
    (x.prototype.on = function (e, t, r) {
      return this._on(e, t, !1, r);
    }),
    (x.prototype.prependListener = function (e, t, r) {
    ...
    (x.prototype._on = function (t, r, n, i) {
      if ("function" == typeof t) return this._onAny(t, r), this;
      if ("function" != typeof r)
      ...
      var s,
        o = this;
      return (
        i !== e && ((r = (s = T.call(this, t, r, i))[0]), (o = s[1])),
        this._newListener && this.emit("newListener", t, r),
        this.wildcard
          ? (L.call(this, t, r, n), o)
          : (this._events[t]
              ? ("function" == typeof this._events[t] &&
                  (this._events[t] = [this._events[t]]),
                n ? this._events[t].unshift(r) : this._events[t].push(r),
                !this._events[t].warned &&
                  this._maxListeners > 0 &&
                  this._events[t].length > this._maxListeners &&
                  ((this._events[t].warned = !0),
                  h.call(this, this._events[t].length, t)))
              : (this._events[t] = r),
            o)
      );
    }),
    (x.prototype.off = function (e, t) {
      ...
      if (this.wildcard) {
        ...
        if (!(i = g.call(this, null, s, this.listenerTree, 0))) return this;
      } else {
      ...
      for (var o = 0; o < i.length; o++) {
        ...
        if (((n = l._listeners), r(n))) {
          for (var a = -1, f = 0, h = n.length; f < h; f++)
            if (
              n[f] === t ||
              (n[f].listener && n[f].listener === t) ||
              (n[f]._origin && n[f]._origin === t)
            ) {
              a = f;
              break;
            }
    ...
    (x.prototype.removeAllListeners = function (t) {
      if (t === e) return !this._events || a.call(this), this;
      if (this.wildcard) {
        var r,
          n = g.call(this, null, t, this.listenerTree, 0);
        if (!n) return this;
        for (r = 0; r < n.length; r++) n[r]._listeners = null;
    ...
    (x.prototype.listeners = function (t) {
      ...
      if (this.wildcard) {
        ...
        var f = [],
          h = "string" == typeof t ? t.split(this.delimiter) : t.slice();
    ...
    (x.prototype.eventNames = function (e) {
      ...
      return this.wildcard
        ? E.call(this, this.listenerTree, [], null, e)
        : t
        ? l(t)
        : [];
    }),
    ...
    (x.prototype.hasListeners = function (t) {
      ...
      var i = this._events,
        s = this._all;
      return !!((s && s.length) || (i && (t === e ? l(i).length : i[t])));
    }),
    (x.prototype.listenersAny = function () {
      return this._all ? this._all : [];
    }),
    (x.prototype.waitFor = function (t, r) {
      var n = this,
        i = typeof r;
      return (
        "number" === i
          ? (r = { timeout: r })
          : "function" === i && (r = { filter: r }),
        b(
          (r = v(
            r,
            {
            ...
            function (r, n, i) {
              ...
              if ("function" == typeof e.addEventListener)
                return (
                  ...
                  void e.addEventListener(t, s, { once: !0 })
                );
              var o,
                l = function () {
              ...
              "error" !== t &&
                ...
                e.once("error", o)),
                i(function () {
                  o && e.removeListener("error", o), e.removeListener(t, l);
                }),
                e.once(t, l);
            },
            { timeout: r.timeout, overload: r.overload },
  ...
  else if ("object" == typeof exports) module.exports = x;
  else {
